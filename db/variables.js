const tasksData = [
    {
      ...
      Шрифт - comfortaa`,
      fullDescription: `Создать дизайн сайта в фигме, с анимациями, переходами на другие страницы.
      Каждую страницу размещать по горизонтали.
      Цвета преимущественно - серый, чёрный и белый, тематика - оптика.
      Шрифт - comfortaa, 20, 24, 32, 48, 64 размеров.
      Необходимо сделать эти страницы:
      - Главная страница
      - Каталог
      - Страница какого-либо товара`,
      dl: '28.05.2022 15:00',
